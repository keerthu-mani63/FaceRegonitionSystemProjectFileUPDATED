...
while cv.waitKey(1) & 0xFF != ord('q'):
    ...
    faces = faceClassifier.detectMultiScale(grey, scaleFactor=1.1, minNeighbors=3)
    ...
    for x, y, w, h in faces:
        ...
        try:
            ...
            cv.putText(img, "Unknown", (x, y+h+30), cv.FONT_HERSHEY_COMPLEX, 1, (0,0,255))
